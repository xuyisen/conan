...
def test_private_skip():
    ...
    client.save(
        {"conanfile.py": GenConanfile().with_requirement("dep/1.0", visible=False)}
    )
...
def test_private_no_skip():
    ...
    client.run("remove dep/1.0:* -c")  # Dep binary is removed not used at all
    client.run(
        "create . --name=app --version=1.0 --build=app/* --build=pkg/*",
        assert_error=True,
    )
...
def test_consumer_no_skip():
    ...
    client.save(
        {"conanfile.py": GenConanfile().with_requirement("pkg/1.0", visible=False)}
    )
...
def test_build_scripts_no_skip():
    ...
    c.save(
        {
            "scripts/conanfile.py": GenConanfile("script", "0.1").with_package_type(
                "build-scripts"
            ),
    ...
    c.assert_listed_binary(
        {"script/0.1": ("da39a3ee5e6b4b0d3255bfef95601890afd80709", "Build")},
        build=True,
    )
    c.run("install app")
    c.assert_listed_binary(
        {"script/0.1": ("da39a3ee5e6b4b0d3255bfef95601890afd80709", "Cache")},
        build=True,
    )
...
def test_list_skip_printing():
    ...
    c.save(
        {
            ...
            "pkga/conanfile.py": GenConanfile("pkga", "0.1").with_tool_requires(
                "tool/0.1"
            ),
    ...
    c.assert_listed_binary(
        {"tool/0.1": ("da39a3ee5e6b4b0d3255bfef95601890afd80709", "Cache")}, build=True
    )
...
def test_conf_skip():
    ...
    client.save(
        {"conanfile.py": GenConanfile().with_requirement("maths/1.0", visible=False)}
    )
    client.run("create . --name=liba --version=1.0")
    client.save(
        {"conanfile.py": GenConanfile().with_requirement("ai/1.0", visible=False)}
    )
    ...
    client.run(
        "create . --name=app --version=1.0 -v -c *:tools.graph:skip_binaries=False"
    )
    ...
    client.run(
        "create . --name=app --version=2.0 -v -c maths/*:tools.graph:skip_binaries=False"
    )
    client.assert_listed_binary({"maths/1.0": (NO_SETTINGS_PACKAGE_ID, "Cache")})
    client.assert_listed_binary({"ai/1.0": (NO_SETTINGS_PACKAGE_ID, "Skip")})

    client.run(
        "create . --name=app --version=3.0 -v -c *:tools.graph:skip_binaries=True"
    )
    client.assert_listed_binary({"maths/1.0": (NO_SETTINGS_PACKAGE_ID, "Skip")})
    client.assert_listed_binary({"ai/1.0": (NO_SETTINGS_PACKAGE_ID, "Skip")})
...
def test_skipped_intermediate_header():
    ...
    c.save(
        {
            ...
            .with_package_info(cpp_info={"libs": ["liba"]}, env_info={}),
    ...
    c.assert_listed_binary(
        {
            "liba/0.1": ("da39a3ee5e6b4b0d3255bfef95601890afd80709", "Cache"),
...
def test_skip_visible_build():
    ...
    c.save(
        {
            "liba/conanfile.py": GenConanfile("liba", "0.1"),
            "libb/conanfile.py": GenConanfile("libb", "0.1").with_requirement(
                "liba/0.1", build=True
            ),
            "libc/conanfile.py": GenConanfile("libc", "0.1").with_requirement(
                "libb/0.1", visible=False
            ),
...
def test_skip_tool_requires_context():
    ...
    c.run(
        "install app -s:a os=Linux -pr=profile -c=tools.graph:skip_binaries=False --build=missing"
    )
    assert 'export MYVAR="MYVALUE"' in c.out
    assert (
        "gtest/1.0: Package '9a4eb3c8701508aa9458b1a73d0633783ecc2270' built" in c.out
    )
...
def test_skip_intermediate_header():
    ...
    c.save(
        {
            "liba/conanfile.py": GenConanfile("liba", "0.1").with_package_type(
                "static-library"
            ),
            "libb/conanfile.py": GenConanfile("libb", "0.1")
    ...
    c.save(
        {
            ...
            .with_requirement("libb/0.1")
            .with_package_type("static-library"),
            "libd/conanfile.py": GenConanfile("libd", "0.1")
            .with_requirement("libc/0.1")
            .with_package_type("static-library"),
            "libe/conanfile.py": GenConanfile("libe", "0.1")
            .with_requirement("libd/0.1")
            .with_package_type("shared-library"),
            "libg/conanfile.py": GenConanfile("libg", "0.1")
            .with_requirement("liba/0.1")
            .with_package_type("header-library"),
            "libf/conanfile.py": GenConanfile("libf", "0.1")
            .with_requirement("libg/0.1")
            .with_package_type("static-library"),
            "libj/conanfile.py": GenConanfile("libj", "0.1")
            .with_requirement("libb/0.1")
            .with_package_type("header-library"),
            "libi/conanfile.py": GenConanfile("libi", "0.1")
            .with_requirement("libj/0.1")
            .with_package_type("header-library"),
            "libh/conanfile.py": GenConanfile("libh", "0.1")
            .with_requirement("libi/0.1")
            .with_package_type("static-library"),
            "app/conanfile.py": GenConanfile("app", "0.1")
            .with_package_type("application")
            .with_requires("libh/0.1", "libe/0.1", "libf/0.1"),
        }
    )
