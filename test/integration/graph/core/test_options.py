...
class TestOptions(GraphManagerTest):
    def test_basic(self):
        ...
        self._check_node(
            liba, "liba/0.1#123", dependents=[libb], options={"shared": "True"}
        )
    ...
    def test_app_override(self):
        ...
        self._check_node(libb, "libb/0.1#123", deps=[liba], dependents=[app])
        self._check_node(
            liba, "liba/0.1#123", dependents=[libb], options={"shared": "False"}
        )
    ...
    def test_diamond_no_conflict(self):
        ...
        self._check_node(libb, "libb/0.1#123", deps=[liba], dependents=[app])
        self._check_node(
            liba, "liba/0.1#123", dependents=[libb, libc], options={"shared": "False"}
        )
        ...
        self._check_node(libb, "libb/0.1#123", deps=[liba], dependents=[app])
        self._check_node(
            liba, "liba/0.1#123", dependents=[libb, libc], options={"shared": "True"}
        )
...
class TestBuildRequireOptions(GraphManagerTest):
    def test_protobuf_different_options_profile(self):
        ...
        self._check_node(
            lib, "lib/0.1#123", deps=[protobuf_host, protobuf_build], dependents=[app]
        )
        self._check_node(
            protobuf_host, "protobuf/0.1#123", deps=[zlib_shared], dependents=[lib]
        )
        self._check_node(
            protobuf_build, "protobuf/0.1#123", deps=[zlib_static], dependents=[lib]
        )
        self._check_node(
            zlib_shared, "zlib/0.1#123", deps=[], dependents=[protobuf_host]
        )
        self._check_node(
            zlib_static, "zlib/0.1#123", deps=[], dependents=[protobuf_build]
        )
