...
def test_shorthand_syntax():
    ...
    assert out == {
        "build": {
            ...
            "options": {},
            "package_settings": {},
            "settings": {"compiler": "clang", "compiler.version": "13", "os": "Linux"},
            "tool_requires": {},
        },
        "host": {
            "build_env": "",
    ...
    assert out == {
        "build": {
            ...
            "options": {},
            "package_settings": {},
            "settings": {"compiler": "gcc", "compiler.version": "11", "os": "Linux"},
            "tool_requires": {},
        },
        "host": {
            "build_env": "",
            ...
            "options": {},
            "package_settings": {},
            "settings": {"compiler": "gcc", "compiler.version": "13", "os": "Linux"},
            "tool_requires": {},
        },
    }
    ...
    assert (
        "Invalid empty package name in options. Use a pattern like `mypkg/*:shared`"
        in tc.out
    )
