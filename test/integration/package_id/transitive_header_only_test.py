...
class TestTransitiveIds:
    def test_transitive_library(self):
        ...
        client.save_home(
            {"global.conf": "core.package_id:default_unknown_mode=full_version_mode"}
        )
    ...
    def test_transitive_major_mode(self):
        ...
        client.assert_listed_binary(
            {"libc/1.0": ("2aa3bb6726dfc6c825a91f3b465b769e770ee902", "Build")}
        )
        # LibD -> LibC
    ...
    def test_transitive_second_level_header_only(self):
        ...
        client.run(
            "create . --name=libe --version=1.0", assert_error=True
        )  # LibD is NOT missing!
