...
def test_basic_default_modes_unknown():
    ...
    c.save(
        {
            "matrix/conanfile.py": GenConanfile("matrix"),
    ...
    c.assert_listed_binary(
        {"engine/1.0": ("805fafebc9f7769a90dafb8c008578c6aa7f5d86", "Build")}
    )
...
class TestDepDefinedMode:
    def test_dep_defined(self):
        ...
        c.run("create pkg")
        c.assert_listed_binary(
            {"pkg/0.1": ("66a9e6a31e63f77952fd72744d0d5da07970f42e", "Build")}
        )
        c.run("create pkg -o pkg/*:shared=True")
        c.assert_listed_binary(
            {"pkg/0.1": ("5a5828e18eef6a86813b01d4f5a83ea7d87d1139", "Build")}
        )
    ...
    def test_dep_tool_require_defined(self):
        ...
        c.run("create pkg")
        c.assert_listed_binary(
            {"pkg/0.1": ("fcf70699eb821f51cd4f3e228341ac4f405ad220", "Build")}
        )
        ...
        c.run("create pkg")
        c.assert_listed_binary(
            {"pkg/0.1": ("56934f87c11792e356423e081c7cd490f3c1fbe0", "Build")}
        )
    ...
    def test_dep_python_require_defined(self):
        ...
        c.run("create pkg")
        c.assert_listed_binary(
            {"pkg/0.1": ("331c17383dcdf37f79bc2b86fa55ac56afdc6fec", "Build")}
        )
        ...
        c.run("create pkg")
        c.assert_listed_binary(
            {"pkg/0.1": ("9b015e30b768df0217ffa2c270f60227c998e609", "Build")}
        )
        c.run("list *:*")
