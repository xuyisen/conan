    ...
    [
        ...
        (
            ...
            [
                ...
                "TEST_DEFINITION2=0",
                "TEST_DEFINITION3=",
                "TEST_DEFINITION4=TestPpdValue4",
...
def test_toolchain_nmake(
    ...
    conf = {
        ...
        "tools.build:sharedlinkflags": serialize_array(sharedlinkflags)
        if sharedlinkflags
        else "",
        "tools.build:exelinkflags": serialize_array(exelinkflags)
        if exelinkflags
        else "",
    }
