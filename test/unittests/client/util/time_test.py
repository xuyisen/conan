...
from conan.internal.util.dates import (
    from_timestamp_to_iso8601,
    _from_iso8601_to_datetime,
...
class TestTime:
    def test_time_conversions(self):
        ...
        expected = datetime.datetime(
            year=2019, month=1, day=10, hour=16, minute=34, second=59, tzinfo=tzutc()
        )
        assert dt == expected
