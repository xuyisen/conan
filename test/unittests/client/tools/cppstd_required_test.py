...
class TestCheckMinCppStd:
    ...
    def test_check_min_cppstd_from_outdated_settings(self, cppstd):
        ...
        assert (
            "Current cppstd ({}) is lower than the required C++ standard (17).".format(
                cppstd
            )
            == str(raises.value)
        )
    ...
    def test_check_min_cppstd_unsupported_standard(self):
        ...
        assert (
            "Current cppstd (gnu14) is lower than the required C++ standard (42)."
            == str(raises.value)
        )
...
class TestCheckMaxCppStd:
    ...
    def test_check_max_cppstd_from_outdated_settings(self, cppstd):
        ...
        assert (
            "Current cppstd ({}) is higher than the required C++ standard (98).".format(
                cppstd
            )
            == str(raises.value)
        )
    ...
    def test_check_max_cppstd_unsupported_standard(self):
        ...
        assert (
            "Current cppstd (gnu17) is higher than the required C++ standard (16)."
            == str(raises.value)
        )
