...
from conan.internal.api.detect.detect_api import (
    _cc_compiler,
    detect_suncc_compiler,
...
class TestDetect:
    ...
    @pytest.mark.parametrize(
        "processor,bitness,version,expected_arch",
        [
    ...
    def test_detect_aix(self, processor, bitness, version, expected_arch):
        with (
            mock.patch("platform.machine", mock.MagicMock(return_value="XXXXXXXXXXXX")),
    ...
    @mock.patch(
        "conan.internal.api.detect.detect_api.detect_clang_compiler",
...
@pytest.mark.parametrize(
    "version_return,expected_version",
    [
        ...
        [
            "gcc.exe (x86_64-posix-seh-rev0, Built by MinGW-Builds project) 15.15.0",
            "15.15.0",
        ],
        ["gcc (GCC) 4.8.1", "4.8.1"],
        [
        ...
        [
            "clang version 18 (https://github.com/llvm/llvm-project.git 461274b81d8641eab64d494accddc81d7db8a09e)",
            "18",
        ],
